...
public enum MovementEnum {
	...
	HALLTOLOUNGEHALLWAY(new Location(555, 90)),
	LOUNGE(new Location(680,90)),
	
	// Second row for GUI placement
	STUDYTOLIBRARYHALLWAY(new Location(177, 220)),
	HALLTOBILLIARDROOMALLWAY(new Location(425,220)),
	LOUNGETODININGROOMHALLWAY(new Location(680, 230)),
	...
	LIBRARYTOCONSERVATORYHALLWAY(new Location(177, 490)),
	BILLIARDROOMTOBALLROOMHALLWAY(new Location(425,490)),
	DININGROOMTOKITCHENHALLWAY(new Location(680,490)),
	
	// Fifth row for GUI placement
	CONSERVATORY(new Location(177,630)),
	CONSERVATORYTOBALLROOMHALLWAY(new Location(306, 630)),
	BALLROOM(new Location(425,630)),
	BALLROOMTOKITCHENHALLWAY(new Location(555, 630)),
